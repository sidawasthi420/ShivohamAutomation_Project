Feature: Navigate to Manual Testing Course
  ...
  Scenario Outline: User navigates to Manual Testing from Courses dropdown and registers for the course
...
#   Background:
#     Given the user launches the website "https://shivohamautomation.com/"
#     And the user is on the Home page
#     When the user clicks on the Courses button
#     And the user selects Manual Testing from the dropdown
#     Then the Manual Testing course page should be displayed
...
#   Scenario Outline: User registers for the Manual Testing course
#     And the user enters Full Name as "<fullName>"
#     And the user enters Email Address as "<email>"
#     And the user enters Phone Number as "<phone>"
#     And the user selects Course as "<course>"
...
#     Examples:
#       | fullName    | email                    | phone      | course      		| startDate  |
#       | Tariq Ahmad | tariqahmad8057@gmail.com | 9258678692 | API Testing 		| 01-05-2025 |
#       | Tariq 		  | tariqahmad@gmail.com		 | 9027482232 | Core JAVA 	  	| 02-06-2025 |
#       | Ahmad 			| tariq57@gmail.com 			 | 9027588892 | Manual Testing 	| 22-08-2025 |
